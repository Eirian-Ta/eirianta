...
import ContactSVG from '../../shared/ContactSVG'
    ...
    return (
      <div id="main-nav">
        ...
        <Container className="nav-pane" style={navPaneVisibility}>
          <Col className="col-p"  onClick={this._handleClick}>
            <Link to="/portfolio">
              <PortfolioSVG />
              <div className="collision">Projects</div>
            </Link>
          </Col>
          <Col className="col-c" onClick={this._handleClick}>
            <Link to="/contact">
              <ContactSVG />
              <div className="collision">Contact</div>
            </Link>            
          </Col>
